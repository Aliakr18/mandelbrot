...
def upload(filename):  #used by original author for transfering binary to SD wirelessly -not used here
...
#run("copy Launcher.dat E:\\Launcher.dat > NUL") not needed
#upload("Launcher.dat") not needed
run("del *.o")
run("del *.out")
#run("del payload.bin") doesn't hurt to leave this
